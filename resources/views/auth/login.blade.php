...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{asset('assets_admin')}}/node_modules/bootstrap-social/bootstrap-social.css">
    ...
    <div class="container mt-5">
        ...
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
           ...
           @endif
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('login_submit') }}" class="needs-validation" novalidate="">
                @csrf
                ...
                <div class="form-group">
                    <button type="submit" name="validate" class="btn btn-primary btn-lg btn-icon icon-right"><i class="fa fa-unlock"></i> Login</button>
                </div>
                <small id="passwordHelpBlock" class="form-text text-muted">
                    Belum punya akun?
                </small>
                    <a href="{{route('register_form')}}">Register Sekarang!</a>
                </form>
            </div>
            </div>
