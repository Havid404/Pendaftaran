          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
              <div class="pull-right">
                  <img style="margin-bottom: 5px;" src="{{asset('storage/'.$detail->photo)}}" width="150" height="200" class="rounded">
              </div>
            </div>
            <div class="form-group">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div id="qrcode" style="display:inline-block;">
                <img style="margin-bottom: 5px;" src="{{asset('storage/'.$detail->photo)}}" width="350" height="200" class="rounded">
              </div>
            </div>
          </div>
        </div>
        <div class="card-footer bg-whitesmoke text-center">
          ...
          <a class="btn btn-info" href="{{ route('layout_cetak') }}">
