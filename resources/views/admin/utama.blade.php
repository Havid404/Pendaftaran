...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{asset('assets_admin')}}/node_modules/jqvmap/dist/jqvmap.min.css">
  <link rel="stylesheet" href="{{asset('assets_admin')}}/node_modules/summernote/dist/summernote-bs4.css">
  <link rel="stylesheet" href="{{asset('assets_admin')}}/node_modules/owl.carousel/dist/assets/owl.carousel.min.css">
  <link rel="stylesheet" href="{{asset('assets_admin')}}/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css">
  ...
  <!-- JS Libraies -->
  <script src="{{asset('assets_admin')}}/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
  <script src="{{asset('assets_admin')}}/node_modules/chart.js/dist/Chart.min.js"></script>
  <script src="{{asset('assets_admin')}}/node_modules/owl.carousel/dist/owl.carousel.min.js"></script>
  <script src="{{asset('assets_admin')}}/node_modules/summernote/dist/summernote-bs4.js"></script>
  <script src="{{asset('assets_admin')}}/node_modules/chocolat/dist/js/jquery.chocolat.min.js"></script>
